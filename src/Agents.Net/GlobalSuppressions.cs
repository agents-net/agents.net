...
[assembly: SuppressMessage("Reliability", "CA2000:Dispose objects before losing scope", Justification = "Message is disposed automatically.", Scope = "member", Target = "~M:Agents.Net.MessageBoard.MessagePublisher.ExecuteInterception(Agents.Net.MessageBoard.MessagePublisher.InterceptionExecution)")]
...
[assembly: SuppressMessage("Design", "CA1021:Avoid out parameters", Justification = "<Pending>", Scope = "member", Target = "~M:Agents.Net.InterceptionAction.Delay(Agents.Net.InterceptionDelayToken@)~Agents.Net.InterceptionAction")]
